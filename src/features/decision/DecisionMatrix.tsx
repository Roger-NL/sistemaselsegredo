...
import { Shield, Target, Cpu, Zap, Lock, ArrowLeft, Briefcase, Plane, BarChart3, ShoppingBag, Heart, Clapperboard, CheckCircle2 } from "lucide-react";
...
export const DecisionMatrix = () => {
  ...
  const getInitialStep = () => {
    ...
    if (specializationStatus === "completed") return "choice";
                ...
                <div className="relative overflow-hidden rounded-xl border-[0.75px] border-white/10 bg-black/95 p-6 md:p-8 shadow-2xl backdrop-blur-xl">
                  ...
                  <div className="relative z-10 text-center flex flex-col items-center justify-center gap-5 md:gap-6">
                    ...
                    <div className="pt-2 w-full flex flex-col gap-3">
                      <button
                        onClick={() => router.push(`${ROUTES.app.specialties}/${currentSpec.id}`)}
                      ...
                      <p className="text-white/50 font-mono text-[10px] md:text-xs leading-relaxed px-2">
                        {canSelect
                          ? specializationStatus === "completed"
                            ? "Especializacao concluida. Outras trilhas avancadas continuam disponiveis."
                            : "Criptografia rompida. Protocolos de especializacao disponiveis."
