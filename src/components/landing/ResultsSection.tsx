...
export function ResultsSection() {
    ...
    return (
        <section className="py-32 px-4 relative overflow-hidden bg-black">
            {/* Background pattern */}
            <div className="absolute inset-0 bg-[linear-gradient(rgba(238,244,212,0.02)_1px,transparent_1px),linear-gradient(90deg,rgba(238,244,212,0.02)_1px,transparent_1px)] bg-[size:60px_60px] pointer-events-none" />
            ...
            <div className="container mx-auto max-w-6xl relative z-10">
                ...
                >
                    <span className="inline-block px-4 py-2 rounded-full border border-green-500/20 bg-green-500/5 text-green-400 font-mono text-xs tracking-widest uppercase mb-6">
                        Resultados Reais
                    </span>
                ...
                >
                    {RESULTS.map((result, index) => (
                        <motion.div
                            ...
                            className="p-6 rounded-2xl border border-white/10 bg-white/[0.02] text-center group hover:border-green-500/30 transition-all"
                        >
                            <result.icon className="w-8 h-8 text-green-400 mx-auto mb-4 group-hover:scale-110 transition-transform" />
                            <div className="text-2xl md:text-3xl font-bold text-white font-mono mb-2">
                                {result.value}
                            </div>
                ...
                <div className="relative">
                    <div className="flex flex-col lg:flex-row gap-8 items-center">
                        ...
                        <motion.div
                            ...
                            className="flex-1 p-8 md:p-12 rounded-3xl border border-white/10 bg-gradient-to-br from-white/[0.05] to-transparent relative overflow-hidden"
                        >
                            ...
                            <div className="relative z-10">
                                <div className="flex items-center gap-4 mb-8">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-white/40 text-sm font-mono">{TESTIMONIALS[activeTestimonial].role} • {TESTIMONIALS[activeTestimonial].location}</p>
                                    </div>
                                </div>

                                <p className="text-xl md:text-2xl font-serif text-white/90 leading-relaxed mb-8 italic">
                                ...
                                <div className="flex gap-8">
                                    <div>
                                        ...
                                        <div className="text-xs text-white/40 font-mono uppercase">Nível Atual</div>
                                    </div>
                                    <div>
                                        <div className="text-2xl font-bold text-green-400 font-mono">
                                            {TESTIMONIALS[activeTestimonial].stats.months}
                                        </div>
                                        <div className="text-xs text-white/40 font-mono uppercase">Tempo de Estudo</div>
                                    </div>
                                </div>
                            </div>
                        </motion.div>
