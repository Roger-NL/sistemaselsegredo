...
export function DevControls({ isAdmin }: DevControlsProps) {
    ...
    return (
        <div className="fixed bottom-20 right-4 md:bottom-4 md:right-52 z-[99999] pointer-events-auto">
            ...
            {isOpen && (
                <div className="absolute bottom-12 right-0 w-[min(22rem,calc(100vw-1.5rem))] max-h-[calc(100dvh-8rem)] overflow-hidden rounded-xl border border-white/20 bg-black/90 backdrop-blur-md shadow-2xl">
