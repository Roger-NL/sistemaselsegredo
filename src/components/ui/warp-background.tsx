...
const Beam = ({
  ...
  // Pick a random color from our palette instead of random Hue
...
export const WarpBackground: React.FC<WarpBackgroundProps> = ({
  ...
  beamDelayMin = 0,
  beamDuration = 3,
  gridColor = "rgba(0, 0, 0, 0.1)", // Subtle black grid for white bg
  ...props
}) => {
  ...
  return (
    <div className={cn("relative w-full h-full bg-transparent", className)} {...props}>
      <div
        style={
          {
      ...
      >
        ...
        {/* LEFT */}
        <div className="absolute [transform-style:preserve-3d] [background-size:var(--beam-size)_var(--beam-size)] [background:linear-gradient(var(--grid-color)_0_1px,_transparent_1px_var(--beam-size))_50%_-0.5px_/var(--beam-size)_var(--beam-size),linear-gradient(90deg,_var(--grid-color)_0_1px,_transparent_1px_var(--beam-size))_50%_50%_/var(--beam-size)_var(--beam-size)] [container-type:inline-size] [height:100cqmax] [transform-origin:0%_50%] [transform:rotateY(90deg)] [width:100cqi]">
        ...
        {/* RIGHT */}
        <div className="absolute right-0 [transform-style:preserve-3d] [background-size:var(--beam-size)_var(--beam-size)] [background:linear-gradient(var(--grid-color)_0_1px,_transparent_1px_var(--beam-size))_50%_-0.5px_/var(--beam-size)_var(--beam-size),linear-gradient(90deg,_var(--grid-color)_0_1px,_transparent_1px_var(--beam-size))_50%_50%_/var(--beam-size)_var(--beam-size)] [container-type:inline-size] [height:100cqmax] [transform-origin:100%_50%] [transform:rotateY(-90deg)] [width:100cqi]">
